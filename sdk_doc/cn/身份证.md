...
...
 android {
     ...
     defaultConfig {
         ...
         //2.0版本以后 身份证功能已经兼容 28 以下,对应so包日期 2020.08.18 以后的版本
         ...
     }
     ...
 }
...
| OnReadModuleListener(OnReadCardIDListener) | 读取身份证uid监听函数|
...
#### 二次开发问题汇总
    1、问:为什么读到的身份证没有图片？
    答：请确认添加了权限 <uses-permission android:name="android.permission.WRITE_EXTERNAL_STORAGE" />