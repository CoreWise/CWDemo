...
/**
 * Created by 金宇凡 on 2020/10/9.
 */
public class RBTagOpenLempFragment extends Fragment {

    private static final String TAG ="RBTagOpenLempFragment";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.rbuhf_tag_open_lemp_layout, container, false);
        ...
        txtEpc = rootView.findViewById(R.id.txtOpenLampEpc);
        ...
        unmpOffset.setNumber((short) 4);
        unmpLength.setNumber((short) 1);
        return rootView;
    }
